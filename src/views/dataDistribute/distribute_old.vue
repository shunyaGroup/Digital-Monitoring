<template>
  <a-card :bordered="false">
    ...
    <div class="btns">
      <a @click="pulldata" style="font-weight: bold;color: #ffffff;background: #0080FF;border-radius: 2px; padding: 1px 5px;">拉取</a>
    ...
    <div>
      <a-modal title="相似文章" v-model="visible4" @ok="V4popOK" okText="完成" width="1200px">
        <div class="btns">
