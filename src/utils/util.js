...
function generateChildRouters(data) {
  ...
  //添加
  // data.push({
  //   component: "system/Wpmanagement",
  //   id: "f1cb187abf927c88b89470d08615f5ad",
  //   meta: {
  //     keepAlive: true,
  //     title: '项目管理'
  //   },
  //   name: "system-Wpmanagement",
  //   path: '/system/Wpmanagement',
  //   route: '1'
  // },
  //   {
  //     component: "system/Wsencemanagement",
  //     id: "f1cb187abf927c88b89470d08615f5ae",
  //     meta: {
  //       keepAlive: true,
  //       title: '场景管理'
  //     },
  //     name: "system-Wsencemanagement",
  //     path: '/system/Wsencemanagement',
  //     route: '1'
  //   },
  //   {
  //     component: "system/Wproductmanagement",
  //     id: "f1cb187abf927c88b89470d08615f5af",
  //     meta: {
  //       keepAlive: true,
  //       title: '产品管理'
  //     },
  //     name: "isystem-Wproductmanagement",
  //     path: '/isystem/Wproductmanagement',
  //     route: '1'
  //   },
  //   )
